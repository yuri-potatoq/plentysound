...
echo "Server = https://github.com/yuri-potatoq/plentysound/releases/download/vX.X.X"
echo ""
echo "IMPORTANT: Use a specific version tag (e.g., v0.1.3) instead of /latest/download"
echo "           to avoid GitHub redirect issues with pacman."
echo ""
