{ stdenv, writeText, rpm, lib, package, libvosk ? null, enableTranscriber ? false, patchelf }:
...
stdenv.mkDerivation {
  ...
  nativeBuildInputs = [ rpm patchelf ];
